<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ include file="/common/taglib.jsp" %>
		...
		<body
			...
			<h1 class="text-center" style="color:white; margin-bottom: 50px;"> <u> Dash Board ADMIN</u> <i
					class='bx bxs-bar-chart-alt-2' style='color:#ffffff'></i></h1>
					...
					<div class="card" style="background-color: #77CDF2; height: 200px;">
						<div class="card-body">
							...
							<div class="d-flex align-items-center justify-content-between ">
								<img alt="" class="img-fluid mb-3 w-25 rounded-circle mr-3"
				...
				<div class="col-md-4 mb-4">
					<div class="card" style="background-color: #77CDF2; height: 200px;">
						<div class="card-body">
							...
							<div class="d-flex align-items-center justify-content-between ">
								<img alt="" class="img-fluid mb-3 w-50  mr-3"

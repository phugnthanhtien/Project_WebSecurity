<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ include file="/common/taglib.jsp" %>
		...
		<head>
			...
			<link rel="stylesheet" href="<c:url value=" /templates/user/css/bootstrap-5.0.2-bootstrap.min.css" />"
			>
		...
		<body class="bg-light"
			...
			<a href="/posts/post/exit/${user.userId}" class="btn btn-primary"
				aria-label="close position-absolute top-0 end-0 m-2" style="top: -50px"> <span aria-hidden="true"><i
						class='bx bx-arrow-back' style='color: #ffffff'></i> Back Home</span>
			</a>
			<div class="container mt-5">
				<h1 class="text-center mt-4 mb-3">
					<i>Dashboard</i> <i class='bx bxs-bar-chart-alt-2' style='color: #ffffff'></i>
				</h1>
				<div class="d-flex justify-content-center align-items-center">

					<img alt="" src="/posts/post/images/${user.avatar}" class="img-fluid mb-3 w-25 rounded-circle mr-3">
			...
			></script>
			<script src="<c:url value=" /templates/user/js/ajax-1.14.7-popper.min.js" />"
			></script>
			<script src="<c:url value=" /templates/user/js/bootstrap-5.0.2-bootstrap.min.js" />"
			></script>
		</body>
